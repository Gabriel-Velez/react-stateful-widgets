...
export default function Programmers() {
  ...
  const [currentProgramer, setCurrentProgramer] = useState(null);
  ...
  const getNameOfFeatured = () => {
    ...
    return programmerList[currentProgramer - 1].name;
  };

  const style = {
    fontSize: "1.5em",
    marginTop: "0.5em",
    color: currentProgramer === null ? "royalblue" : "gold",
  };
